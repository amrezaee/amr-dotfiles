      ...
      local servers = {
          ...
          settings = {
            ...
            python = {
              analysis = {
                ...
                -- Enable type stub generation for better inference
                stubPath = vim.fn.stdpath 'data' .. '/site/stubs', -- Optional: custom stub path
              },
            },
          },
          on_attach = function(client, bufnr)
            client.server_capabilities.documentFormattingProvider = false -- Disable Pyright formatting
            -- Enable completion and code actions
        ...
        ruff = {
          ...
          lint = {
            enable = true,
            preview = true,
            select = { 'C', 'E', 'F', 'W', 'I', 'N', 'UP', 'B', 'C90', 'D', 'PL', 'TRY', 'ANN', 'RUF' },
            ignore = {
              'ANN101',
              'ANN102', -- Ignore self/cls annotations
              'D105',
              'D106',
              'D107', -- Ignore Django-specific docstring issues
              'PLR2004', -- Ignore magic value comparisons (common in Django ORM)
            },
          },
          format = {
            preview = true,
